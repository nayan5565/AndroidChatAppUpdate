...
import com.example.dev.chatapplication.adapter.SectionsPagerAdapter;
...
//        getSupportActionBar().setTitle("Chat App");
    ...
    private void sendToStart() {
        ...
        Intent startIntent = new Intent(MainActivityNew.this, StartActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.main_all_btn){
            ...
            Intent settingsIntent = new Intent(MainActivityNew.this, UserActivityNew.class);
            startActivity(settingsIntent);
